...
public class IoxPolygonizer
{
   ...
   */
  public IoxPolygonizer(double newVertexOffset)
  {
	  this.newVertexOffset=newVertexOffset;
  }
  ...
  private void polygonize()
  {
    ...
    if(newVertexOffset>0.0){
        graph.removeOverlaps(newVertexOffset);
    }
