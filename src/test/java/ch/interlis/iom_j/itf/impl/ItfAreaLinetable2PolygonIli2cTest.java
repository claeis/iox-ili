...
public class ItfAreaLinetable2PolygonIli2cTest {
	...
	public void setup() throws Ili2cFailure
	{
		...
		assertNotNull(td);
		tableB=(Table) ((Container<Element>) ((Container<Element>) td.getElement(Model.class, "Test1")).getElement(Topic.class, "TopicB")).getElement(Table.class, "TableB");
	...
	public void test1() throws Iox2jtsException, IoxException {
		...
		ItfAreaLinetable2Polygon builder=new ItfAreaLinetable2Polygon(formAttr);
