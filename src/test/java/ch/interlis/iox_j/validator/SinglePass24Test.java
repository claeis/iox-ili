...
public class SinglePass24Test {
	
	private TransferDescription td=null;
    private final static String MODEL="SinglePass24";
	// TOPIC
	...
	public void setUp() throws Exception {
		...
		FileEntry fileEntry=new FileEntry("src/test/data/validator/SinglePass24.ili", FileEntryKind.ILIMODELFILE);
