...
public class TextFunction24Test {
    ...
    // MODEL
    private final static String TOPIC = "TextFunction24.Topic";
    ...
    public void setUp() throws Exception {
        ...
        {
            FileEntry fileEntry = new FileEntry("src/test/data/validator/Text_V2.ili", FileEntryKind.ILIMODELFILE);
            ili2cConfig.addFileEntry(fileEntry);
        }
        {
            FileEntry fileEntry = new FileEntry("src/test/data/validator/TextFunction24.ili", FileEntryKind.ILIMODELFILE);
            ili2cConfig.addFileEntry(fileEntry);
        }
    ...
    public void concat_Fail() {
        ...
        assertEquals("Mandatory Constraint TextFunction24.Topic.ClassA2.Constraint1 is not true.",
    ...
    public void endsWith_Fail() {
        ...
        // Asserts
        assertEquals(1, logger.getErrs().size());
        assertEquals("Mandatory Constraint TextFunction24.Topic.ClassA3.Constraint1 is not true.",
                logger.getErrs().get(0).getEventMsg());
    }
    ...
    public void equalsIgnoreCase_Fail() {
        ...
        // Asserts
        assertEquals(1, logger.getErrs().size());
        assertEquals("Mandatory Constraint TextFunction24.Topic.ClassA4.Constraint1 is not true.",
                logger.getErrs().get(0).getEventMsg());
    }
    ...
    public void indexOf_Fail() {
        ...
        // Asserts
        assertEquals(1, logger.getErrs().size());
        assertEquals("Mandatory Constraint TextFunction24.Topic.ClassA5.Constraint1 is not true.",
                logger.getErrs().get(0).getEventMsg());
    }
    ...
    public void lastIndexOf_Fail() {
        ...
        // Asserts
        assertEquals(1, logger.getErrs().size());
        assertEquals("Mandatory Constraint TextFunction24.Topic.ClassA6.Constraint1 is not true.",
                logger.getErrs().get(0).getEventMsg());
    }
    ...
    public void matches_Fail() {
        ...
        // Asserts
        assertEquals(1, logger.getErrs().size());
        assertEquals("Mandatory Constraint TextFunction24.Topic.ClassA7.Constraint1 is not true.",
                logger.getErrs().get(0).getEventMsg());
    }    
    ...
    public void replace_Fail() {
        ...
        // Asserts
        assertEquals(1, logger.getErrs().size());
        assertEquals("Mandatory Constraint TextFunction24.Topic.ClassA8.Constraint1 is not true.",
                logger.getErrs().get(0).getEventMsg());
    }
    ...
    public void startsWith_Fail() {
        ...
        // Asserts
        assertEquals(1, logger.getErrs().size());
        assertEquals("Mandatory Constraint TextFunction24.Topic.ClassA9.Constraint1 is not true.",
                logger.getErrs().get(0).getEventMsg());
    }
    ...
    public void substring_Fail() {
        ...
        // Asserts
        assertEquals(1, logger.getErrs().size());
        assertEquals("Mandatory Constraint TextFunction24.Topic.ClassA10.Constraint1 is not true.",
                logger.getErrs().get(0).getEventMsg());
    }
    ...
    public void substringWithFromAndTOParameter_Fail() {
        ...
        // Asserts
        assertEquals(1, logger.getErrs().size());
        assertEquals("Mandatory Constraint TextFunction24.Topic.ClassA11.Constraint1 is not true.",
                logger.getErrs().get(0).getEventMsg());
    }
}
