...
public class SurfaceOverlab10Test {
	...
	public void setUp() throws Exception {
		...
		FileEntry fileEntry=new FileEntry("src/test/data/validator/SurfaceOverlabTest10.ili", FileEntryKind.ILIMODELFILE);
	...
	@Test
	public void surfaceWithoutOverlaps2d_noOverlabOfInnerboundaries_OK(){
		Iom_jObject objSurfaceSuccess=new Iom_jObject("SurfaceOverlabTest10.Topic.FlaechenTable", "o1");
		...
		validator.validate(new StartBasketEvent("SurfaceOverlabTest10.Topic","b1"));
	...
	public void lines2D_polylineTypeStraights_Ok(){
		Iom_jObject objStraightsSuccess=new Iom_jObject("SurfaceOverlabTest10.Topic.LineTable", "o1");
	...
	public void lines2D_polylineTypeArcs_Ok(){
		...
		coord.setattrvalue("A2", "70000.000");
		ValidationConfig modelConfig=new ValidationConfig();
		LogCollector logger=new LogCollector();
		LogEventFactory errFactory=new LogEventFactory();
		Settings settings=new Settings();
	...
	@Test
	public void surfaceWithoutOverlaps2d_overlabs_ExpectedFailToValidatePolygon_BecauseOverlabOf2Lines_Fail(){
		Iom_jObject objSurfaceSuccess=new Iom_jObject("SurfaceOverlabTest10.Topic.FlaechenTable", "o1");
		IomObject multisurfaceValue=objSurfaceSuccess.addattrobj("surfaceWithoutOverlaps2d", "MULTISURFACE");
		IomObject surfaceValue = multisurfaceValue.addattrobj("surface", "SURFACE");
		// outer boundary
	...
	@Test
	public void surfaceWithoutOverlaps2d_overlabs_ExpectedIntersectionErrs_Fail(){
		Iom_jObject objSurfaceSuccess=new Iom_jObject("SurfaceOverlabTest10.Topic.FlaechenTable", "o1");
		IomObject multisurfaceValue=objSurfaceSuccess.addattrobj("surfaceWithoutOverlaps2d", "MULTISURFACE");
		IomObject surfaceValue = multisurfaceValue.addattrobj("surface", "SURFACE");
		// outer boundary
...
//		IomObject coord=null;
//		coord=segments.addattrobj("segment", "COORD");
//		coord.setattrvalue("C1", "482000.000");
//		coord.setattrvalue("C2", "71000.000");
//		coord=segments.addattrobj("segment", "ARC");
//		coord.setattrvalue("A1", "483500.000");
//		coord.setattrvalue("A2", "73000.000");
//		coord.setattrvalue("C1", "485000.000");
//		coord.setattrvalue("C2", "71000.000");
//		coord=segments.addattrobj("segment", "ARC");
//		coord.setattrvalue("A1", "483500.000");
//		coord.setattrvalue("A2", "72000.000");
//		coord.setattrvalue("C1", "483000.000");
//		coord.setattrvalue("C2", "70500.000");
//		ValidationConfig modelConfig=new ValidationConfig();
//		LogCollector logger=new LogCollector();
//		LogEventFactory errFactory=new LogEventFactory();
//		Settings settings=new Settings();
...
//		// Asserts
//		assertEquals(1,logger.getErrs().size());
//		assertEquals("Attribute lineWithoutOverlaps2dArc has an invalid self-intersection at (480005.0, 70000.0)", logger.getErrs().get(0).getEventMsg());
//	}
