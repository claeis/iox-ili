...
public class SurfaceOverlab10Test {
	...
	// MODEL.TOPIC
	private final static String ILI_TOPIC="SurfaceOverlabTest10.Topic";
	// CLASS
	...
	// there are 2 innerboundaries which dont touch each other. Expected: ok.
	@Test
	public void surfaceWithoutOverlaps3d_noOverlabOfInnerboundaries_OK(){
		Iom_jObject objSurfaceSuccess=new Iom_jObject(ILI_CLASSFLAECHENTABLE, OBJ_OID1);
	...
	// 4 edges are cut. Expected: Errs(failed to validate polygon).
	@Test
	public void surfaceWithoutOverlaps3d_overlabs_ExpectedFailToValidatePolygon_BecauseOverlabOf2Lines_Fail(){
		Iom_jObject objSurfaceSuccess=new Iom_jObject(ILI_CLASSFLAECHENTABLE, OBJ_OID1);
		IomObject multisurfaceValue=objSurfaceSuccess.addattrobj("surfaceWithoutOverlaps3d", "MULTISURFACE");
		IomObject surfaceValue = multisurfaceValue.addattrobj("surface", "SURFACE");
		// outer boundary
	...
	// intersection of 2 innerboundary and outboundary. Expected: Errs(failed to validate polygon - intersections)
	@Test
	public void surfaceWithoutOverlaps3d_overlabs_ExpectedIntersectionErrs_Fail(){
		Iom_jObject objSurfaceSuccess=new Iom_jObject(ILI_CLASSFLAECHENTABLE, OBJ_OID1);
		IomObject multisurfaceValue=objSurfaceSuccess.addattrobj("surfaceWithoutOverlaps3d", "MULTISURFACE");
		IomObject surfaceValue = multisurfaceValue.addattrobj("surface", "SURFACE");
		// outer boundary
