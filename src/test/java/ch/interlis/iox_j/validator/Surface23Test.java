...
public class Surface23Test {
	...
	public void innerBoundaryOverlayOuterBoundaryLine_BoundariesAreClosed_Fail(){
		...
		assertEquals("Overlay coord1 (500000.0, 300000.0, NaN), coord2 (500000.0, 100000.0, NaN), tid1 o1, tid2 o1", logger.getErrs().get(0).getEventMsg());
	...
	public void overlayOf2Lines_InnerLineDiffXAndYCoords_Fail(){
		...
		// Asserts
		assertTrue(logger.getErrs().size()==2);
		assertEquals("Overlay coord1 (500000.0, 100000.0, NaN), coord2 (500000.0, 300000.0, NaN), tid1 o1, tid2 o1", logger.getErrs().get(0).getEventMsg());
		assertEquals("failed to validate polygon", logger.getErrs().get(1).getEventMsg());
	}
