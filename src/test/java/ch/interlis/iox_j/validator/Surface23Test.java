...
public class Surface23Test {
	...
	// Es wird getestet, ob eine Polygon erstellt werden in.
	@Test
	...
	// Es wird getestet, ob eine Polygon, welche sich selber an 1 Segmentpunkt schneidet erstellt werden kann.
	@Test
	public void surfaceCutHerselfOn1Point_Ok(){
		Iom_jObject objSurfaceSuccess=new Iom_jObject(ILI_CLASSC, OID1);
		IomObject multisurfaceValue=objSurfaceSuccess.addattrobj("surface2d", "MULTISURFACE");
		IomObject surfaceValue = multisurfaceValue.addattrobj("surface", "SURFACE");
		// outer boundary
	...
	@Test
	public void surfaceInnerboundariesTouchEachOtherOn1Point_Ok(){
		Iom_jObject objSurfaceSuccess=new Iom_jObject(ILI_CLASSC, OID1);
		IomObject multisurfaceValue=objSurfaceSuccess.addattrobj("surface2d", "MULTISURFACE");
		IomObject surfaceValue = multisurfaceValue.addattrobj("surface", "SURFACE");
		// outer boundary
	...
	// wenn die ring lines der Surface nicht geschlossen sind.
	@Test
