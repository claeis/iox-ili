...
public class IniFileReaderTest {
    ...
    public void comments() throws Exception {
        ...
        assertNotNull(ini.getConfigParams("Beispiel1#Bodenbedeckung.Gebaeude2"));
        assertEquals("Assekuranz-Nr2 #AssNr#", ini.getConfigValue("Beispiel1#Bodenbedeckung.Gebaeude2", "keymsg#de"));
    }
